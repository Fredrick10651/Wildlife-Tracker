...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/animals", ((request, response) -> {
            Map<String, Object> model = new HashMap<>();
            List<EndangeredAnimals> animals = EndangeredAnimals.allAnimals();
...
//            try {
            EndangeredAnimals endangeredAnimal = new EndangeredAnimals(name,age,health);
...
//            }
        ...
        get("/endangered/:id/delete", (request, response) -> {
            ...
            EndangeredAnimals.find(Integer.parseInt(request.params(":id"))).delete();
            response.redirect("/endangered");
...
//            try {
            NonEndangeredAnimals nonEndangeredAnimal = new NonEndangeredAnimals(name,age,health);
...
//            }
        ...
        get("/non-endangered", ((request, response) -> {
            Map<String, Object> model = new HashMap<>();
            List<NonEndangeredAnimals> nonEndangeredAnimals = NonEndangeredAnimals.all();
        ...
        get("/non-endangered/:id/delete", (request, response) -> {
            ...
            NonEndangeredAnimals.find(Integer.parseInt(request.params(":id"))).delete();
            response.redirect("/non-endangered");
        ...
        get("/sighting/new", (request, response) -> {
            Map<String, Object> model = new HashMap<>();
            List<EndangeredAnimals> endangeredAnimals = EndangeredAnimals.allAnimals();
            List<Object> animals = new ArrayList<>();
            for (int i=0;i<endangeredAnimals.size();i++){
                animals.add(EndangeredAnimals.allAnimals().get(i));
            }
        ...
        post("/sighting/new", ((request, response) -> {
            ...
            try {
                Sightings sighting = new Sightings(rangerName,animalId,location);
